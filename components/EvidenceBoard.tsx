...
// ⚡ Bolt Optimization: Memoize the node rendering to prevent O(N) re-renders
// during high-frequency events like drag-and-drop.
const MemoizedEvidenceNode = React.memo<{
  node: EvidenceNode;
  isSelected: boolean;
...
}>(({ node, isSelected, isConnectTarget, isGrabbing, onMouseDown, onClick, onDelete }) => {
