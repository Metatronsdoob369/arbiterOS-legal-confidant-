...
// ⚡ Bolt Optimization: Memoize individual evidence nodes
// Why: Prevents re-rendering all nodes (O(N)) on every mouse movement during a drag operation.
// Impact: Reduces rendering overhead significantly, keeping drag interactions at 60fps even with many nodes.
        ...
        >
          ...
          {nodes.map(node => (
            <MemoizedNode
              ...
              isConnectTarget={connectMode !== null && connectMode.from !== node.id}
