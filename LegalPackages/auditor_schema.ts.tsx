...
// Define the ValidationStep interface and schema
...
export const ValidationStepZod = z.object({
  rule_id: z.string(),
  passed: z.boolean(),
  details: z.string(),
...
// Define Section162aContract interface and schema
export interface Section162aContract {
  taxpayer_naics_code: string;
  expense_item_category: string;
  expense_amount: number;
  business_revenue: number;
}

export const Section162aContractZod = z.object({
  taxpayer_naics_code: z.string(),
  expense_item_category: z.string(),
  expense_amount: z.number(),
  business_revenue: z.number(),
});

// Define AuditResult interface and schema
export interface AuditResult {
  is_deductible: boolean;
  failed_rules: string[];
}

export const AuditResultZod = z.object({
